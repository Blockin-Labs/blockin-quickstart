...
export function BadgeDataForm({
    ...
    const setNextButton = (newStepNum: number) => {
        if (newStepNum === 0) {
            ...
            // setNextButtonDisabled(!isuri.isValid(imageUrl)); TODO:
        } else if (newStepNum === 5) {
            setNextButtonDisabled(!backgroundColor);
        } else if (newStepNum === 6) {
            // setNextButtonDisabled(externalUrl && !isuri.isValid(externalUrl)); TODO:
                        ...
                        <>
                            ...
                            >
                                <Select
                                    ...
                                    onSelect={(e: any) => setBackgroundColor(e)}
                                    style={{
                                        backgroundColor: PRIMARY_BLUE,
                                        color: PRIMARY_TEXT,
                                    }}
