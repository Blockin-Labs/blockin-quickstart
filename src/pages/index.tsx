    ...
    return (
        <>
            ...
            <section style={{ textAlign: 'center' }} className='home'>
                ...
                <p>The ENS resolution may be a bit slow because it currently uses the default shared API keys for all users of <a href="https://docs.ethers.io/v5/api/providers/#providers-getDefaultProvider" target="_blank" rel="noreferrer">getDefaultProvider from ethers.js.</a> (click the link to add your own API keys). This is defined in the currentChainInfo prop of blockin_button.tsx. You may also choose to implement a new ENS resolution function if you wish.</p>
            </section>
        </>
    )
}
